...
public class listDto implements Serializable{
	...
	public listDto(int seq, int category_id, String user_id, String title, String imgurl1, String imgurl2, String imgurl3,
	...
	public String toString() {
		return "List [seq=" + seq + ", category_id=" + category_id + ", user_id=" + user_id + ", title=" + title
