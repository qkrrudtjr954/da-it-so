...
public class DetailPageView extends JFrame implements ActionListener,MouseListener {
	...
	public DetailPageView(ItemBbs Idto, Person PersonDto) {
		this.Idto = Idto;
		this.Adto = Adto;
		...
		// titleLb
		titleLb = new JLabel(Idto.getTitle());
		titleLb.setFont(new Font(Idto.getTitle(), Font.BOLD, 25));
		...
		subimage1 = new JPanel() {
			ImageIcon image1 = new ImageIcon(Idto.getImgurl1());
		...
		subimage2 = new JPanel() {
			ImageIcon image2 = new ImageIcon(Idto.getImgurl2());
		...
		subimage3 = new JPanel() {
			ImageIcon image3 = new ImageIcon(Idto.getImgurl3());
		...
		subimage4 = new JPanel() {
			ImageIcon image4 = new ImageIcon(Idto.getImgurl4());
		...
		// detailtitleLb
		detailtitleLb = new JLabel(Idto.getTitle());
		detailtitleLb.setBounds(10, 10, 340, 30);
		detailtitleLb.setFont(new Font(Idto.getTitle(), Font.BOLD, 20));
		iteminfoPn.add(detailtitleLb);
	

		// detailprice
		priceLb = new JLabel(Idto.getPrice() + "");
		priceLb.setBounds(10, 40, 340, 30);
		priceLb.setFont(new Font(Idto.getPrice() + "", Font.BOLD, 15));
		iteminfoPn.add(priceLb);

		// keyword
		
		String key = Idto.getKeyword();
	...
	/*			if(i==0 && j==0) {
		...
		//categori
		cateLb = new JLabel("카테고리 : "+Idto.getCategory_id()); 
		...
		//item explanation
		explanationLb = new JLabel("저품 설명 : "+Idto.getContent());
		explanationLb.setBounds(10,150 , 300, 10*Idto.getContent().length());
